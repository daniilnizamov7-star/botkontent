...
- Женат, двое детей: старший сын (первый класс, учит английский) и совсем маленькая дочка
...
ALL_TOPICS = {
    ...
    "work_life": [
        ...
        "двое детей и завод — когда вообще на IT время находить",
    ...
    "lesso": [
        ...
        "делал Lesso для старшего — он первый студент на платформе",
...
CATEGORY_PROMPTS = {
    ...
    "lesso": "Напиши пост про Lesso и тему: {topic}. Расскажи как это связано с реальной болью репетиторов или с личным опытом (старший учится).",
    ...
    "mini_projects": "Напиши пост про: {topic}. Расскажи историю создания — что толкнуло на идею, сколько заняло, что получилось. Живо, конкретно, с цифрами если есть.",
}
